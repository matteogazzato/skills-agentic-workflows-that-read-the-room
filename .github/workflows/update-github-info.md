...
description: Update GitHub information content from the latest GitHub Blog posts, changelog, and Awesome Copilot workflow resources.
on:
  schedule: daily
  workflow_dispatch:
permissions:
...
6. Don't write directly to `main`. Use the `create-pull-request` safe output to open a draft pull request for Mona to review. Use a pull request title that mentions Mona or GitHub Info. Summarize the source material and the content changes in the pull request body.