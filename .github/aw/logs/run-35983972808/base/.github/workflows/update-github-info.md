...
6. Use the `create-pull-request` safe output to open a pull request for Mona to review. Summarize the source material and the content changes in the pull request body.
